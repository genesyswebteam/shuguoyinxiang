...
Future<Map> retrieveImageHowToUse() async{
  var _envelope =
  '''<?xml version="1.0" encoding="utf-8"?>
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <RetrievePictureHowTouse xmlns="http://tempuri.org/"/>
  </soap:Body>
</soap:Envelope>''';
  try{
    http.Response response = await http.post(
        ...
        headers: {
          ...
          "SOAPAction": "http://tempuri.org/RetrievePictureHowTouse",
    ...
    for(int i=0; i < mapIdImage.length; i++){
      var _data = {"idImage":mapIdImage[i],"picture":mapPicture[i]};
